...
(function() {
    ...
    YAHOO.example.DDApp = {
        init : function() {
            var questionspans = YAHOO.util.Dom.getElementsByClassName("sddl_questionid_for_javascript");
    ...
    YAHOO.extend(YAHOO.example.DDPlayer, YAHOO.util.DD, {
        ...
        startDrag : function(x, y) {
            YAHOO.util.Dom.setStyle(this.getEl(), "zIndex", sddl_currentzindex++);
